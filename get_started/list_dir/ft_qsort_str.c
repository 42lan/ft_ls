...
/*   Updated: 2019/06/05 19:58:23 by amalsago         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_qsort_str(char **array, int left, int right)
{
	int			pivot_location;
	...
	if (left < right)
	{
		...
		ft_qsort_str(array, left, pivot_location - 1);
		ft_qsort_str(array, pivot_location + 1, right);
	}
}
